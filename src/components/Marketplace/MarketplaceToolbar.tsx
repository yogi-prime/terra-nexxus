// sections/MarketplaceToolbar.tsx
        ...
        <div className="flex items-center gap-3 w-full lg:w-auto justify-between lg:justify-end">
          ...
          <Select value={sortBy} onValueChange={onSortChange}>
            ...
            <SelectContent>
              ...
              <SelectItem value="sqft-high">Area (Large to Small)</SelectItem>
              <SelectItem value="sqft-low">Area (Small to Large)</SelectItem>
              <SelectItem value="possession">Near Possession</SelectItem>
